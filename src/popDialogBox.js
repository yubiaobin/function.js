	...
	if (typeof exports == 'object'){
		...
		var popDialogShow = function(obj){
			...
			var btnArg1 = Boolean(typeof options.buttonNum == 'object'),
				...
				btnArg3 = options.buttonNum ? options.buttonNum.length : 0;
			...
			popBox.style.top = (window.innerHeight / 2) + currentScrollTop  + 'px';
			popBox.style.left = '0';
			...
			/*让弹出框居中显示*/
			var popContentHeight = parseInt(popCenter.currentStyle ? popCenter.currentStyle : window.getComputedStyle(popCenter, null).height);
			popBox.style.top = ((window.innerHeight - popContentHeight) / 2) + currentScrollTop + 'px';
